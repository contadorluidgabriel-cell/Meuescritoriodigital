...
export function applyTaskQuickExecutionPatch(root) {
  ...
  if (!command.includes('MED_INFORMATION_ARCHITECTURE_V12_2') && !command.includes('MED_INFORMATION_ARCHITECTURE_V12_3') && !command.includes("TaskQuickExecution from './TaskQuickExecution.jsx'")) {
